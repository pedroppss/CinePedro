...
class ControllerCorreo
{
    ...
    //Método para enviar un correo para poder cambiar la contraseña
    //Recibe como parámetro la dirección de correo del receptor y el emisor, y la contraseña
    public static function enviarCorreoPassword($receptor,$gmail,$password)
    {
        //var_dump($receptor);
        //var_dump($gmail);
        ...
        //Cuerpo del mensaje
        $message = '<h1>CONTRASEÑA:'.$password.'</h1><br><a href="http://143.47.43.204:8080/pedro/Cine-Pedro/app/views/login_register.php?ctl=login">Iniciar sesion</a> <br> Enviado el día: ' . date("Y-m-d H:i:s");
