...
<main class="bg-fond_inicio rounded-2xl">
    ...
    <section class="ml-8 mt-[50px] flex gap-[15px]">
        <a href="javascript:abrir()" class="w-[99px] h-[46px] rounded-[6.26px] bg-button_2 text-color_button_2 font-poppins  font-normal text-[18px]"><p class="text-center mt-2">Genres</p></a>
        ...
        <div class=" bg-fond_transp hidden" style="padding: 12px; width: 324px; border-radius: 12px; margin-left: 14rem; " id="ventana">
            <form action="index.php?ctl=busquedaPelicula" method="POST">
