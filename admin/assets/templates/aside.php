...
<div class="nk-aside " data-content="sideNav" data-toggle-overlay="true" data-toggle-screen="lg" data-toggle-body="true">
                                <div class="nk-sidebar-menu " data-simplebar>
                                    ...
                                    <ul class="nk-menu">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            <a href="app/views/login_register.php?ctl=peliculas" class="nk-menu-link nk-menu-toggle">
                                                <span class="nk-menu-icon"><em class="icon ni ni-tile-thumb"></em></span>
                                                <span class="nk-menu-text">Peliculas</span>
                                            </a>
                                            <ul class="nk-menu-sub">
                                                <li class="nk-menu-item">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            <a href="app/views/login_register.php?ctl=actoresactricesdirectores" class="nk-menu-link nk-menu-toggle">
                                                <span class="nk-menu-icon"><em class="icon ni ni-users"></em></span>
                                                <span class="nk-menu-text">Actores , Actrices y Directores</span>
                                            </a>
                                            <ul class="nk-menu-sub">
                                                <li class="nk-menu-item">
                                        ...
                                        <li class="nk-menu-item has-sub">
                                            <a href="app/views/login_register.php?ctl=usuarios" class="nk-menu-link nk-menu-toggle">
                                                <span class="nk-menu-icon"><em class="icon ni ni-user-list"></em></span>
                                                <span class="nk-menu-text">Usuarios</span><span class="nk-menu-badge">New</span>
                                            </a>
                                            <ul class="nk-menu-sub">
                                                <li class="nk-menu-item">
