                                    ...
                                    <div class="components-preview wide-md mx-auto">
                                        <div class="nk-block-head nk-block-head-lg wide-sm">
                                            <div class="nk-block-head-content">
                                                ...
                                                <h2 class="nk-block-title fw-normal">Lista de Salas-Sesiones</h2>
                                                ...
                                                <p class="lead">Esto es una lista de todos las Salas-Sesiones</p>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                        <div class="nk-block nk-block-lg">
                                            <div class="nk-block-head">
                                                <div class="nk-block-head-content">
                                                    <h4 class="nk-block-title">Salas-Sesiones</h4>
                                                </div>
                                            </div>
                                            <div class="card card-bordered card-preview">
                                                <div class="card-inner">
                                                    <table class="datatable-init table">
                                                        ...
                                                        <tbody>
                                                        <?php foreach($_SESSION['salas'] as $sala){ ?>
                                                            <tr>
                                                                <td><?php echo $sala['titulo'] ?></td>
                                                                <td><?php echo $sala['nombreSala'] ?></td>
                                                                <td><?php echo $sala['butacas'] ?></td>
                                                                <td><?php echo $sala['fecha'] ?></td>
                                                                <td><?php echo $sala['hora'] ?></td>
                                                                <td><?php echo $sala['precioSesion'] ?></td>
                                                            </tr>
                                                           <?php } ?>
                                                        </tbody>
                                                    </table>
