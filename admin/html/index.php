                                                    ...
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                ...
                                                                <p>Lista,añadir y modificar Peliculas</p>
                                                            </div>
                                                        </div>
                                                        <div class="nk-wg1-action">
                                                            <a href="app/views/login_register.php?ctl=peliculas" class="link"><span>Peliculas</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                                ...
                                                <div class="card card-bordered card-full">
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                <h5 class="title">Actores, Actrices y Directores</h5>
                                                                <p>Lista,añadir y modificar Actores, Actrices y Directores</p>
                                                            </div>
                                                        </div>
                                                        <div class="nk-wg1-action">
                                                            <a href="app/views/login_register.php?ctl=actoresactricesdirectores" class="link"><span>Actores, Actrices y Directores</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                                    ...
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                ...
                                                                <p>Lista,añadir y modificar Usuarios</p>
                                                            </div>
                                                        </div>
                                                        <div class="nk-wg1-action">
                                                            <a href="app/views/login_register.php?ctl=usuarios" class="link"><span>Usuarios</span> <em class="icon ni ni-chevron-right"></em></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div><!-- .col -->
                                                    ...
                                                    <div class="nk-wg1">
                                                        <div class="nk-wg1-block">
                                                            ...
                                                            <div class="nk-wg1-text">
                                                                ...
                                                                <p>Lista,añadir y modificar Salas</p>
                                                            </div>
                                                        </div>
                                                        <div class="nk-wg1-action">
