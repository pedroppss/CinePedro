                                    ...
                                    <div class="components-preview wide-md mx-auto">
                                        <div class="nk-block-head nk-block-head-lg wide-sm">
                                            <div class="nk-block-head-content">
                                                ...
                                                <p class="lead">Esto es para eliminar cuentas de los usuarios
                                                </p>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                        <div class="nk-block nk-block-lg">
                                            <div class="nk-block-head">
                                                <div class="nk-block-head-content">
                                                    <h4 class="nk-block-title">Eliminacion de usuarios</h4>
                                                </div>
                                            </div>
                                            <form action="app/views/login_register.php?ctl=eliminarcuentas" method="POST">
                                                <div class="form-group">
                                                    <label class="form-label" for="default-01">Nombre del correo del usuario</label>
                                                        <div class="form-control-wrap">        
                                                            <input  class="form-control" type="text" name="correoUsuario" id="correoUsuario" placeholder="correo del Usuario">    
                                                        </div>
                                                    <br>
