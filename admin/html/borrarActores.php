<!--esto es un formulario para borrar Actores-->
<!DOCTYPE html>
                                    ...
                                    <div class="components-preview wide-md mx-auto">
                                        <div class="nk-block-head nk-block-head-lg wide-sm">
                                            <div class="nk-block-head-content">
                                                <div class="nk-block-head-sub"><a class="back-to" href="app/views/login_register.php?ctl=actoresactricesdirectores"><em class="icon ni ni-arrow-left"></em><span>Lista de Actores, Actrices y Directores</span></a></div>
                                                <h2 class="nk-block-title fw-normal">Borrar Actores, Actrices o Directores</h2>
                                                ...
                                                <p class="lead">Esto es para Borrar Actores, Actrices o Directores
                                                </p>
                                                </div>
                                            </div>
                                        </div><!-- .nk-block-head -->
                                        <div class="nk-block nk-block-lg">
                                            <div class="nk-block-head">
                                                <div class="nk-block-head-content">
                                                    <h4 class="nk-block-title">Borrado de Actores/ces y Directores</h4>
                                                </div>
                                            </div>
                                            <form action="app/views/login_register.php?ctl=borrarActores" method="POST">
                                                <div class="form-group">
                                                    <label class="form-label" for="default-01">Nombre del Actor o Actriz o Director</label>
                                                        <div class="form-control-wrap">        
                                                            <input  class="form-control" type="text" name="nombreActorActrizDirector" id="nombreActorActrizDirector" placeholder="Nombre del Actor o Actriz o Director">    
                                                        </div>
                                                    <br>
